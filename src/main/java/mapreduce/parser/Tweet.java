...
public class Tweet {
	...
	private String full_text; // actual UTF-8 text of the status update
	...
	public String getText() {return this.full_text;}
	...
	public void setText(String text) {this.full_text = text;}
	...
	public String toString () {		
		...
		return this.id_str+","+this.user.getId_str()+","+this.user.getScreen_name()+","+this.retweet_count+","+this.in_reply_to_status_id_str+","+this.full_text;
	}
